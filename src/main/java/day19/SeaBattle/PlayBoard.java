        ...
        if (count4 == 0) {
            ...
            try {
                ...
                if (x2 == x1 + 1 && y2 == y1 || x2 == x1 && y2 == y1 + 1 || x2 == x1 - 1 && y2 == y1 || x2 == x1 && y2 == y1 - 1
                        || x3 == x2 + 1 && y3 == y2 || x3 == x2 && y3 == y2 + 1 || x3 == x2 - 1 && y3 == y2 || x3 == x2 && y3 == y2 - 1
                        || x4 == x3 + 1 && y4 == y3 || x4 == x3 && y4 == y3 + 1 || x4 == x3 - 1 && y4 == y3 || x4 == x3 && y4 == y3 - 1)
                {
                    if (!board[x1][y1].equals(Ship.FOG_WAR.getShip()) || !board[x2][y2].equals(Ship.FOG_WAR.getShip())
                        ...
                        board[x3][y3] = Ship.TWO_DECK.getShip();
                        board[x4][y4] = Ship.TWO_DECK.getShip();
                        count4--;
                        gameBoard();
                        printBoard();
                    }
